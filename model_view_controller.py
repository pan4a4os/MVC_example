...
#Show all items only when "bullet_points == True"
c.show_items(bullet_points=True)

#Show anything because this product doesn`t have in list
c.show_item('chocolate')

#Show only one product of list it`s "bread"
c.show_item('bread')

#Do nothing because this product is already listed
c.insert_item('bread', price=1.0, quantity=5)

#Create new item in list "chocolate"
c.insert_item('chocolate', price=2.0, quantity=10)

#Show only "chocolate"
c.show_item('chocolate')

#Updated the list and added a milk at the end of the list
c.update_item('milk', price=1.2, quantity=20)

#Did nothing because we don`t have 'ice cream' in our list
c.update_item('ice cream', price=3.5, quantity=20)

#Did nothing because we don`t have 'fish' in our list
c.delete_item('fish')

#Remove 'bread' from our list
c.delete_item('bread')
